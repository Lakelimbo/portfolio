        ...
        <div className="divide-gray-700 xl:divide-y">
          ...
          >
            ...
            <div className="divide-y divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none pt-10 pb-8 text-gray-400">{children}</div>
            </div>
            <footer>
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && (
                      <div>
                        ...
                        <div className="text-purple-400 hover:text-purple-200">
              ...
              <div className="pt-4 xl:pt-8">
                <Link href="/blog" className="hover:text-purple-20 text-purple-400">
